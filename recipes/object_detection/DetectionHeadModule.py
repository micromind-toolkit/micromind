...
def parse_model_custom(nc, ch, verbose=True):
    ...
    if verbose:
        LOGGER.info(f"\n{'':>3}{'from':>20}{'n':>3}{'params':>10}  {'module':<45}{'dimensions':<30}")
    ch = [ch]
    ...
    # To fix the ouptut args of the model --> needs to be changed

    layer9 = SPPF(256,256, 5)
    layer9.i, layer9.f, layer9.type, layer9.n = 9, -1, 'ultralytics.nn.modules.block.SPPF', 1        
    ...
    layer10.i, layer10.f, layer10.type, layer10.n = 10, -1, 'torch.nn.modules.upsampling.Upsample', 1
    ...
    layer11 = Concat(1)
    layer11.i, layer11.f, layer11.type, layer11.n = 11, [-1,6], 'ultralytics.nn.modules.conv.Concat', 1
    ...
    layer12.i, layer12.f, layer12.type,layer12.n = 12, -1, 'ultralytics.nn.modules.block.C2f', 3
    ...
    layer13.i, layer13.f, layer13.type, layer13.n = 13, -1, 'torch.nn.modules.upsampling.Upsample', 1
    ...
    layer14 = Concat(1)
    layer14.i, layer14.f, layer14.type, layer14.n = 14, [-1,4], 'ultralytics.nn.modules.conv.Concat', 1
    ...
    layer15.i, layer15.f, layer15.type, layer15.n = 15, -1, 'ultralytics.nn.modules.block.C2f', 3
    ...
    layer16.i, layer16.f, layer16.type, layer16.n = 16, -1, 'ultralytics.nn.modules.conv.Conv', 1
    ...
    layer17 = Concat(1)
    layer17.i, layer17.f, layer17.type, layer17.n = 17, [-1,12], 'ultralytics.nn.modules.conv.Concat', 1
    ...
    layer18.i, layer18.f, layer18.type, layer18.n = 18, -1, 'ultralytics.nn.modules.block.C2f', 3
    ...
    layer19.i, layer19.f, layer19.type, layer19.n = 19, -1, 'ultralytics.nn.modules.conv.Conv', 1
    ...
    layer20 = Concat(1)
    layer20.i, layer20.f, layer20.type, layer20.n = 20, [-1,8], 'ultralytics.nn.modules.conv.Concat', 1
    ...
    layer21.i, layer21.f, layer21.type, layer21.n = 21, -1, 'ultralytics.nn.modules.block.C2f', 3
    ...
    head.i, head.f, head.type, head.n = 22, [15,18,21], 'ultralytics.nn.modules.conv.Detect', 1
