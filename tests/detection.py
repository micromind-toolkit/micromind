...
def train_nn(a):
    ...
    # also the number of downsampling layers changes according to the deeper_layer flag (from 6 to 7)
    ...
    # you can change the number of feature sizes according to the number of downsampling layers
    # usually the number of detection heads is 3, but it can be changed according to the task
    # the fewer the detection heads, the more the speedup
    # to choose which head to use, you need to change the number of heads in the number_heads parameter
    # also you need to change the head_concat_layers parameter to match the number of heads
